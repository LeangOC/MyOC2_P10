...
| US-05 | Gestion du compte           | Gestion du profil                | En tant que client, je veux consulter et modifier mes informations personnelles afin de maintenir mon profil à jour.                    | Must Have   |
...
| US-09 | Recherche                   | Filtrage et tri                  | En tant qu'utilisateur, je veux filtrer et trier les résultats afin de trouver plus facilement une offre.                               | Should Have |
...
| US-16 | Confirmation                | Confirmation                     | En tant que client, je veux recevoir une confirmation afin de disposer d'une preuve de ma réservation.                                  | Must Have   |
